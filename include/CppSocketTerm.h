...
enum Error{NOERROR,INCURRECT_SERVICE,TIMEOUT,BINDING_ERROR,SOCKET_ERROR,LISTENING_ERROR,CONNECTING_ERROR,ADDRESS_IN_USE,INVALID_SIZE};   // this enum is use to show the socket error in the transmission progress
